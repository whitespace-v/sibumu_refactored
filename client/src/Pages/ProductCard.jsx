...
import tempImg from "../picture_izBrazzerie/temp_img.png"; // Временная картинка продукта
...
import { addOrder, uppBasket } from "./ReducerRedux";
...
const ProductCard = () => {
    ...
    function loadData(data) {
        ...
        setProductWeight(Number(data.weight)* 1000);
	...
	useEffect(() => {
		axios.get("/api/product/" + productId).then(data => loadData(data))
	}, [])
    ...
    function addElementInBasket() {
		...
		dispatch(addOrder({ id: productId, img: productPicLink, name: productName, count: countAdd, price: productPrice, summa: productPrice, gramm:  costPerGram, guid: productGuid, special: false}));
	}
        ...
        <div className="App">
            ...
            <div className='card_body'>
                ...
                <div className='text_information'>
                    ...
                    <div className='weight'><b>Вес:</b> {productWeight} грамм</div>
                    ...
                    <motion.div transition={{duration: 1, delay: 1.5}}>
                        <motion.a className='product_card_go_back_button' href='/menu' whileHover={{borderColor: "#cebda0", color: "#ffffff", backgroundColor:"#cebda0", opacity: 1}}>Назад в меню</motion.a>
                    </motion.div>
