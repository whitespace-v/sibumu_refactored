...
const ArrayOfBlocks = ({img_title, img_title_png}) => {
    let blocks = [
        {id:1, img: img_title, img_png: img_title_png, title: "ДОСТАВКА ОСУЩЕСТВЛЯЕТСЯ С 11:00 ДО 20:00", text: 'Доставка по городу до зари 200₽\nДоставка от зари до седанки 500₽\nДоставка от седанки до трудового 1200₽\nДоставка в аэропорт 2000₽\n'.split('\n').map(str => <p>{str}</p>)}
